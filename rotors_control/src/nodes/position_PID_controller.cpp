...
public:
  ...
  std::unique_ptr<dynamic_reconfigure::Server<mbzirc_simulator::ControlConfig>::CallbackType> f;
  ...
  void dynReconfCb(mbzirc_simulator::ControlConfig &config, uint32_t level);
};
...
//:filtered_error_(3,0)
{
  ...
  server.reset(new dynamic_reconfigure::Server<mbzirc_simulator::ControlConfig>);
  f.reset(new dynamic_reconfigure::Server<mbzirc_simulator::ControlConfig>::CallbackType);
  *f = boost::bind(&PositionPID::dynReconfCb, this, _1, _2);
  server->setCallback(*f);

  sub_gazebo_pos = nh.subscribe("/firefly1/ground_truth/odometry", 1, &PositionPID::gazebo_pos_callback, this); //cambiar para que acepte distintos drones
  sub_target_pos = nh.subscribe("/firefly1/targetPose", 1, &PositionPID::target_pos_callback, this);
...
void PositionPID::dynReconfCb(mbzirc_simulator::ControlConfig &config, uint32_t level)
{
