...
//:filtered_error_(3,0)
{
  ...
  *f = boost::bind(&VelocityPID::dynReconfCb, this, _1, _2);
  ...
  sub_gazebo_vel = nh.subscribe("/firefly1/ground_truth/odometry", 1, &VelocityPID::gazebo_vel_callback, this); //cambiar para que acepte distintos drones
...
void VelocityPID::dynReconfCb(mbzirc_simulator::ControlConfig &config, uint32_t level)
{
